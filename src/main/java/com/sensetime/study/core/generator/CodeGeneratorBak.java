...
package com.sensetime.study.core.generator;
...
import com.sensetime.study.core.constant.ProjectConstant;
 ...
 * </p>
 * 
 * @createTime 2018年6月22日下午3:59:12
 */
public class CodeGeneratorBak {

	// JDBC配置，请修改为你项目的实际配置
	private static final String JDBC_URL = "jdbc:mysql://localhost:3306/backendsystem";
	...
	public static void main(String[] args) {
		genCode("system_log", "SystemLog");
		genCode("user_info", "UserInfo");
	}

	/**
	 * 通过数据表名称生成代码，Model名称通过解析数据表名称获得，下划线转大驼峰的形式。 如输入表名称
	 * "t_user_detail" 将生成
	...
	/**
	 * 通过数据表名称，和自定义的 Model 名称生成代码 如输入表名称 "t_user_detail" 和自定义的 Model
	 * 名称 "User"
	...
	private static JavaClientGeneratorConfiguration getJavaClientGeneratorConfiguration() {
		...
		javaClientGeneratorConfiguration.addProperty("rootInterface", ProjectConstant.MAPPER_INTERFACE_REFERENCE);
